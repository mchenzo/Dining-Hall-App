...
/* This file contains the Cart class, which is used to manage app state.
 * It tracks orders from all of the respective dining hall pages.
 * The code is not as elegant as it could be.
...
public class Cart {
	...
	//All methods except the last one in this class are simple getters and setters
	...
	/**
	 * orderValue method, returns the total value of all of the orders
	 * @return double representing the total monetary value of all the 
	 * orders
	 */
